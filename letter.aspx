...
strSQL = "SELECT *, (RATING/ NO_RATES) AS RATES FROM Recipes WHERE Name LIKE '" & Replace(Recletter, "'", "''") & "%' ORDER BY " & Replace(recipesqlorderby, "'", "''") & "" 
...
'Display sort category links
 Sub SortCategoryLink()
        ...
        Else 
           LinkMostPopular.NavigateUrl = "letter.aspx?l=" & strRecletter & "&sid=" & 2
           LinkMostPopular.Text = "Most Popular"
           LinkMostPopular.ToolTip = "Sort by Most Popular Recipes"
        End if
        ...
        Else 
           LinkHighestRated.NavigateUrl = "letter.aspx?l=" & strRecletter & "&sid=" & 1
           LinkHighestRated.Text = "Highest Rated"
           LinkHighestRated.ToolTip = "Sort by Newest Rated Recipes"
        End if
        ...
        Else 
           LinkNewest.NavigateUrl = "letter.aspx?l=" & strRecletter & "&sid=" & 3
           LinkNewest.Text = "Newest"
        ...
        Else 
           LinkName.NavigateUrl = "letter.aspx?l=" & strRecletter & "&sid=" & 4 & "&ob=" & 1
           LinkName.Text = "Name ASC"
 ...
 Sub CountNumberRecipes()
        ...
        Dim getletter as string
        getletter = Request.QueryString("l")

  strSQL = "SELECT Count(Name) FROM Recipes WHERE Name LIKE '" & Replace(getletter, "'", "''") & "%'"

       'Call Open database - connect to the database      
        DBconnect()

        objCommand.Connection.Open()
lblrcdcount.Text = "There are&nbsp;" & "( " & objCommand.ExecuteScalar() & " )" & "&nbsp;recipes starting with letter&nbsp;" & getletter 
...
<asp:HyperLink tooltip="Back to recipe homepage" id="HyperLink1" cssClass="dtcat" runat="server" />
</div>
</td>
    <td width="16%" rowspan="5" valign="top">
<!--Begin Random Recipe-->
