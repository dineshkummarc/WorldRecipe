...
<script runat="server">
  ...
  Sub Page_Load(Sender As Object, E As EventArgs)
         ...
         lblPagename.text = "Sort Recipe"     
         lblsortcat.text = "Order By:"   
...
strSQL = "SELECT * FROM Recipe_Letter Order By Letter ASC"
 ...
 Sub GetCatCategory()
    ...
    If(CStr(Request.QueryString("sid")) = "0") Then
	   ...
	   action = "Date"
        ...
        ElseIf(CStr(Request.QueryString("sid")) = "1") Then
           action = "NO_RATES"
           strCaption = "Sorted by: 50 Highest Rated Recipes"

        ElseIf(CStr(Request.QueryString("sid")) = "2") Then
          action = "HITS"
          strCaption = "Sorted by: 50 Most Popular Recipes"

        ElseIf(CStr(Request.QueryString("sid")) = "3") Then
         action = "Date"
         strCaption = "Sorted by: 50 Newest Recipes"

        ElseIf(CStr(Request.QueryString("sid")) = "4") Then
	   action = "Name"
           strCaption = "Sorted by: 50 Name ASC Recipes"
  ...
  'which is set to Date field, else append from querystring OB
...
strSQL = "SELECT TOP 50 *, (RATING/NO_RATES) AS Rates FROM Recipes ORDER BY " & Replace(recipesqlorderby, "'", "''") & "" 
...
'Display sort category links
 Sub SortAscDesc()
        ...
        Dim strOB as integer = Request.QueryString("ob")

        If strOB = "1" Then
           LinkAsc.Enabled = False
           LinkAsc.Text = "Ascending"
        Else 
           LinkAsc.NavigateUrl = "sortrecipe.aspx?sid=" & strSid & "&ob=" & 1
           LinkAsc.Text = "Ascending"
           LinkAsc.ToolTip = "Sort by Ascending"
        End if

        If strOB = "2" Then
           LinkDesc.Enabled = False
           LinkDesc.Text = "Descending"
        Else 
           LinkDesc.NavigateUrl = "sortrecipe.aspx?sid=" & strSid & "&ob=" & 2
           LinkDesc.Text = "Descending"
           LinkDesc.ToolTip = "Sort by Descending"
        End if
...
strSQL = "SELECT Top 15 ID,Name,HITS,Category FROM Recipes Where LINK_APPROVED = 1 Order By Date DESC"
 ...
 'Sub Display 15 most popular recipes
 Sub MostPopular()
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="16%" valign="top" rowspan="5">
...
<asp:HyperLink tooltip="Back to recipe homepage" id="HyperLink1" cssClass="dtcat" runat="server" />&nbsp;<span class="bluearrow">�</span>&nbsp;<asp:Label cssClass="content10" runat="server" id="lblPagename" />
</div>
</td>
    <td width="16%" valign="top" rowspan="5">
<!--Begin Random Recipe-->
...
<br />
<asp:Label cssClass="content8" runat="server" id="lblranhitsdis" /> <asp:Label cssClass="content2" runat="server" id="lblranhits" />
<br />
...
<asp:HyperLink id="LinkAsc" cssClass="dt" runat="server" /> |
<asp:HyperLink id="LinkDesc" cssClass="dt" runat="server" />
</div>
</td>
  </tr>
  <tr>
...
<div class="divbd">
Category:&nbsp;<a class="dt" title="Go to <%# DataBinder.Eval(Container.DataItem, "Category") %> category" href='<%# DataBinder.Eval(Container.DataItem, "CAT_ID", "category.aspx?catid={0}") %>'><%# DataBinder.Eval(Container.DataItem, "Category") %></a>
<br />
