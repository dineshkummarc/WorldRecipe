...
<a class="catlink" title="Click this link to add a recipe in <%# DataBinder.Eval(Container.DataItem, "CAT_TYPE") %> category" href='<%# DataBinder.Eval(Container.DataItem, "CAT_ID", "addrecipe.aspx?catid={0}") %>'><%# DataBinder.Eval(Container.DataItem, "CAT_TYPE") %></a> 
       </div>
       </div>
      </ItemTemplate>
  </asp:DataList>
