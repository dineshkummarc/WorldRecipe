...
<script runat="server">
    ...
    'Event handler. When button is click check login and password with database users table
    ...
    Sub btnlogin_Click(Sender as Object, e as EventArgs)
        ...
        'Variables username and password value
        CheckUname = uname.Text
        Checkpass = password.Text
                
        'Text to display the login error message
...
<br />
<br />
<div style="text-align: center;"><a title="Go to the recipe homepage" href="recipehome.aspx">Go to the recipe homepage</a></div>
    </form>
</body>
</html>
